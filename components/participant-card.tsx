...
export function ParticipantCard({
  ...
  return (
    <>
      <Card
        className={cn(
          "overflow-hidden transition-all duration-300 p-0", // no padding on the Card
          entry.isChampion ? "border-2 border-amber-300 shadow-md" : "",
        )}
      >
        {/* TOP SECTION: Cupcake Image Container */}
        <div className="relative h-64 w-full">
          ...
          {/* Participant Profile Image (avatar) */}
          <div
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-secondary rounded-full h-2.5">
              <div
                className={cn(
                  "h-2.5 rounded-full",
                  entry.isChampion ? "bg-amber-500" : "bg-primary",
                )}
