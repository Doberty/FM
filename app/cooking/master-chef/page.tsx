...
export default function MasterChefPage() {
  // filert to not include the cupcake wars competitions
  const masterChefCompetitions = competitions.filter((comp) => comp.type != "cupcake-wars")

  const upcomingCompetitions = masterChefCompetitions.filter((comp) => comp.status === "upcoming")
  const ongoingCompetitions = masterChefCompetitions.filter((comp) => comp.status === "ongoing")
          ...
          <Tabs defaultValue="timeline" className="w-full">
            ...
            <TabsContent value="timeline" className="mt-6">
              <Card>
                ...
                <CardContent>
                  <CompetitionTimeline competitions={masterChefCompetitions} />
                </CardContent>
              </Card>
            </TabsContent>
